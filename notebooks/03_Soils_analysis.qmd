...
#| fig-cap: "Change in riparian organic layer WEP concentrationfollowing grazing or mowing in each of the landscape positions. A significant effect of treatment was detected; however, the post-hoc analysis was not able to detect any significant (p < 0.05) pairwise contrasts."
...
```{r}
#| label: fig-soil-WEP
#| fig-cap: "Change in riparian Ah layer (0-10cm) WEP concentrationfollowing grazing or mowing in each of the landscape positions. No significant effect of treatment or landscape position was detected."
